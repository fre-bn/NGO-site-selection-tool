...
def main():
    ...
    We would like to help you with the leap into unknown territory; the selection process of new project sites.
    Alternatively, the app can be used for a check-up of a current project. 

    Tourism can be of great benefit or detriment to an area. Therefore, scientific and conservation tourism aims to ensure benefits to not only the tourism business, 
    ...
    This tool is developed to communicate the compatibility of scientific and tourism strategy from the results of the assessments.
    For every theme, we show the alignment of the strategy (NGO capability) and the current state of resource management (community capacity), 
    and give suggestions on possible improvements. 
    Show your team what is on your radar!

    -Lieke, Malik, Javier, Lars and Frederique
   (This project is open source as of a consultancy project of Msc Sustainable development students)
  ...
  **Upload a CSV file (.csv) with the following format:**
    ...
    *Note: First row can contain headers (they will be automatically detected and skipped)*
    ...
    if uploaded_file is not None:
        ...
        if themes is not None and community_capacities is not None and ngo_capabilities is not None:
            ...
            with col2:
                ...
                strategic_recommendations = {
                    '1. Awareness & Education': "improving communication on the effects of conservation, or reaching out to younger generations",
                    '2. Community Governance': "strengthening ties with community members to gain trust",
                    '3. Tradition Preservation': "collaborating with the community to include traditional elements in ecotourism",
                    '4. Income & Revenue': "adapting business model to increase the portion of the revenue reserved for tour guide salaries and conservation",
                    '5. Employment': "offer employment to more local residents with opportunities to develop skills and expertise",
                    '6. Amenities': "improve infrastructure for the daily lives of residents and adapt it to accommodate tourists",
                    '7. Biotic factors': "creating habitat improvements for the natural resource",
                    '8. Abiotic factors': "strengthening fishing conservation efforts",
                    '9. Ecosystem composition': "strengthening and implementing area protection regulations"
                }
      ...
      #  example_data = {
     #       'Theme': ['1. Awareness & Education', '2. Community Governance', '3. Tradition Preservation',
      #                '4. Income & Revenue', '5. Employment', '6. Amenities', 
       #               '7. Habitat Conservation', '8. Shark Preservation', '9. Protected Area'],
